...
const DATA: Task[] = [
  ...
  { id: 10000004, title: 'Go to the gym', date: new Date('2022-01-04'), priority: 'High', completed: true },
  { id: 10000005, title: 'Cook dinner', date: new Date('2022-01-05'), priority: 'Medium', completed: false },
  { id: 10000006, title: 'Walk the dog', date: new Date('2022-01-06'), priority: 'Low', completed: true },
  { id: 10000007, title: 'Clean the car', date: new Date('2022-01-07'), priority: 'High', completed: false },
  { id: 10000008, title: 'Read a book', date: new Date('2022-01-08'), priority: 'Medium', completed: true },
  { id: 10000009, title: 'Go to the movies', date: new Date('2022-01-09'), priority: 'Low', completed: false },
  { id: 100000010, title: 'Take a nap', date: new Date('2022-01-10'), priority: 'High', completed: true },
  { id: 100000011, title: 'Go for a run', date: new Date('2022-01-11'), priority: 'Medium', completed: false },
  { id: 100000012, title: 'Call a friend', date: new Date('2022-01-12'), priority: 'Low', completed: true },
  ...
  { id: 100000016, title: 'Wake up', date: new Date('2022-01-16'), priority: 'High', completed: true },
  { id: 100000017, title: 'Brush teeth', date: new Date('2022-01-17'), priority: 'Medium', completed: false },
  { id: 100000018, title: 'Eat breakfast', date: new Date('2022-01-18'), priority: 'Low', completed: true },
  { id: 100000019, title: 'Go to work', date: new Date('2022-01-19'), priority: 'High', completed: false },
  { id: 100000020, title: 'Go to school', date: new Date('2022-01-20'), priority: 'Medium', completed: true },
  { id: 100000021, title: 'Go to the park', date: new Date('2022-01-21'), priority: 'Low', completed: false },
  { id: 100000022, title: 'Go to the zoo', date: new Date('2022-01-22'), priority: 'High', completed: true },
  { id: 100000023, title: 'Go to the library', date: new Date('2022-01-23'), priority: 'Medium', completed: false },
  { id: 100000024, title: 'Go to the store', date: new Date('2022-01-24'), priority: 'Low', completed: true },
  { id: 100000025, title: 'Go to the restaurant', date: new Date('2022-01-25'), priority: 'High', completed: false },
  { id: 100000026, title: 'Go to the bar', date: new Date('2022-01-26'), priority: 'Medium', completed: true },
  { id: 100000027, title: 'Go to the club', date: new Date('2022-01-27'), priority: 'Low', completed: false },
  ...
  { id: 100000031, title: 'Go to the river', date: new Date('2022-01-31'), priority: 'High', completed: false },
  ...
  { id: 100000034, title: 'Go to the pool', date: new Date('2022-02-03'), priority: 'High', completed: true },
  ...
  { id: 100000046, title: 'Go to the river', date: new Date('2022-02-15'), priority: 'High', completed: true },
  { id: 100000047, title: 'Go to the ocean', date: new Date('2022-02-16'), priority: 'Medium', completed: false },
  { id: 100000048, title: 'Go to the sea', date: new Date('2022-02-17'), priority: 'Low', completed: true },
  { id: 100000049, title: 'Go to the pool', date: new Date('2022-02-18'), priority: 'High', completed: false },
  { id: 100000050, title: 'Go to the gym', date: new Date('2022-02-19'), priority: 'Medium', completed: true },
  { id: 100000051, title: 'Go to the park', date: new Date('2022-02-20'), priority: 'Low', completed: false },
  { id: 100000052, title: 'Go to the zoo', date: new Date('2022-02-21'), priority: 'High', completed: true },
  { id: 100000053, title: 'Go to the library', date: new Date('2022-02-22'), priority: 'Medium', completed: false },
  { id: 100000054, title: 'Go to the store', date: new Date('2022-02-23'), priority: 'Low', completed: true },
  { id: 100000055, title: 'Go to the restaurant', date: new Date('2022-02-24'), priority: 'High', completed: false },
  { id: 100000056, title: 'Go to the bar', date: new Date('2022-02-25'), priority: 'Medium', completed: true },
  { id: 100000057, title: 'Go to the club', date: new Date('2022-02-26'), priority: 'Low', completed: false },
  { id: 100000058, title: 'Go to the beach', date: new Date('2022-02-27'), priority: 'High', completed: true },
  { id: 100000059, title: 'Go to the mountains', date: new Date('2022-02-28'), priority: 'Medium', completed: false },
  { id: 100000060, title: 'Go to the lake', date: new Date('2022-03-01'), priority: 'Low', completed: true },
  { id: 100000061, title: 'Go to the river', date: new Date('2022-03-02'), priority: 'High', completed: false },
  { id: 100000062, title: 'Go to the ocean', date: new Date('2022-03-03'), priority: 'Medium', completed: true },
